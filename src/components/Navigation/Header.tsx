        ...
        <div className="flex items-center justify-between gap-4">
          ...
          <div className="hidden md:flex flex-1 max-w-md items-center relative">
            <input
              ...
              className="w-full px-4 py-2 border border-neutral-200 rounded-full focus:outline-none focus:ring-2 focus:ring-amber-700 transition-all"
            />
            ...
            >
              ...
              <div className="mb-4 flex items-center relative">
                <input
                  ...
                  value={searchQuery}
                  onChange={(e) => handleSearch(e.target.value)}
                  className="w-full px-4 py-2 border border-neutral-200 rounded-full focus:outline-none focus:ring-2 focus:ring-amber-700"
                />
                <Search className="absolute right-3 text-neutral-400" size={18} />
              </div>
