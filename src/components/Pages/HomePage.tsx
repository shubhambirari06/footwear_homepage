...
export const HomePage: React.FC<HomePageProps> = ({ onOpenAuth }) => {
  ...
  const genders = useMemo(() => Array.from(new Set(products.map(p => p.gender).filter(Boolean))), []);
              ...
              <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
                ...
                >
                  ...
                  <p className="text-neutral-600">
                    Showing {(currentPage - 1) * productsPerPage + 1} to {Math.min(currentPage * productsPerPage, displayProducts.length)} of {displayProducts.length} products
                  </p>
                </motion.div>
                      ...
                      <div className="hidden md:flex items-center justify-between">
                        ...
                        <div>
                          <p className="text-sm text-neutral-600">
                            ...
                            to{' '}
                            <span className="font-semibold text-neutral-900">
                              {Math.min(currentPage * productsPerPage, displayProducts.length)}
                            </span>{' '}
                            of{' '}
                            <span className="font-semibold text-neutral-900">
                              {displayProducts.length}
                        ...
                        <nav className="isolate inline-flex -space-x-px rounded-lg shadow-sm">
                          {/* Previous Button */}
                          <motion.button
                            whileHover={currentPage !== 1 ? { backgroundColor: '#f5f5f5' } : {}}
                          ...
                          {/* Next Button */}
                          <motion.button
                            whileHover={currentPage !== totalPages ? { backgroundColor: '#f5f5f5' } : {}}
